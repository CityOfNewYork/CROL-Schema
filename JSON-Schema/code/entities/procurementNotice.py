...
class ProcurementNotice(Skeleton):
    class Options(object):
        title = 'ProcurementNotice'
        definition_id = 'ProcurementNotice'
        description = 'ProcurementNotice, a sub-schema, is used ' \
                      'for publishing notices for procurement ' \
                      'notices from the Mayors Office of Contract ' \
                      'Services (will depreciate and merge into ' \
                      'open-contracting.org framework)'
